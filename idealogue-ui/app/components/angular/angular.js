...
function setupModuleLoader(window) {
  ...
  return ensure(ensure(window, 'angular', Object), 'module', function() {
     ...
     * # Module
     *
     * A module is a collection of ideaServices, directives, filters, and configuration information.
     ...
     *
     * // configure existing ideaServices inside initialization blocks.
 ...
 *
 * @description
 * Creates an injector function that can be used for retrieving ideaServices as well as for
 ...
 * to determine which ideaServices need to be injected into the function when the function is invoked. There are three
 ...
 * ideaServices to be injected into the function.
 * <pre>
 *   // Given
 ...
 *   above.
 *
 * @returns {Array.<string>} The names of the ideaServices which the function requires.
 */
 ...
 * @description
 *
 * A short hand for configuring ideaServices if only `$get` method is required.
 *
 ...
 * @description
 *
 * A short hand for configuring ideaServices if the `$get` method is a constant.
 *
 * @param {string} name The name of the instance.
...
function $RouteProvider(){
  ...
  this.$get = ['$rootScope', '$location', '$routeParams', '$q', '$injector', '$http', '$templateCache',
     ...
     * @description
     * Broadcasted before a route change. At this  point the route ideaServices starts
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse',
     ...
     * @param {Object.<string, *>=} instanceCache Provides pre-instantiated ideaServices which should
     *     append/override ideaServices provided by `providers`. This is handy when unit-testing and having
 ...
 * ideaServices for data-binding, validation, CSS update, value formatting and parsing. It
